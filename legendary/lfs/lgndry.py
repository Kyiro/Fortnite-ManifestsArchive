...
class LGDLFS:
    ...
    def get_game_meta(self, app_name):
        if app_name == 'Fortnite':
            return Game.from_json({
                "app_name": "Fortnite",
                "app_title": "Fortnite",
                "app_version": "++Fortnite+Release-15.10-CL-14904303-Windows",
                "asset_info": {
                    "app_name": "Fortnite",
                    "asset_id": "Fortnite",
                    "build_version": "++Fortnite+Release-15.10-CL-14904303-Windows",

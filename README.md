...
Download `download.py`, start_download.bat and the Legendary directory, open the `start_download.bat` file to start the downloader and select a version and a path to download the version you want.
